...
//    @Test
//    private void test(){
//        driver.get(Config.MAIN_URL + "/vets");
...
//    }
    ...
    private void addVeterinarianTest() {
        ...
        veterinarian.setType("testSpeciality");
        addSpecialtyIfNotExists(veterinarian.getType());

        driver.get(Config.MAIN_URL + "/vets/add");
        ...
        saveVetButton.click();
        driver.manage().timeouts().implicitlyWait(1000, TimeUnit.MILLISECONDS);
        Assert.assertEquals(driver.getCurrentUrl(), Config.MAIN_URL + "/vets");
    ...
    private void addSpecialtyIfNotExists(String type){
        driver.get(Config.MAIN_URL + "/specialties");
        Assert.assertEquals(driver.getTitle(),"SpringPetclinicAngular");
